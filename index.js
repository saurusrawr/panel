...
// Configuration
const apikey = 'ptla_PpZyGMIF7xvhSeiNPsABtTGqf6kbdCg57CaCeucpBbM';
const capikey = 'ptlc_PRtsRgxHTsO2mYR5PoApHnCLiNj39WS4WpaYprobjkL';
const domain = 'https://privt-by-triodevv.cfxcloud.com';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8164247644:AAFzXhm9AEt2tuvw2HBAgdWkDQNzUp0s2EE';
const adminTelegramId = '6918729990';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'saurus' && password === 'ganteng123') {
    res.json({ success: true, user: { username: 'saurus', role: 'admin' } });
  } else {
